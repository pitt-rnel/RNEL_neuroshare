...
parser = argparse.ArgumentParser(description="Read a NFx file")
...
if save_format == "matlab":
  save_string = save_file + "Global_Header.mat"
  channel_headers = []
...
if save_format == "json":
  save_string = save_file + "Global_Header.json"
  channel_headers = []
  for i in range(0, channel_count):
